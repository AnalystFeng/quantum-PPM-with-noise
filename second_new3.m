...
% end
% semilogy(alpha_list,1-Pc,'--*b')
% hold on
% semilogy(alpha_list,1-Pc_n,'-db')
...
semilogy(alpha_list,1-Pc,'--pg','Linewidth',2)
hold on
semilogy(alpha_list,1-Pc_n,'-+g','Linewidth',2)
...
semilogy(alpha_list,1-Pc,'--pb','Linewidth',2)
hold on
semilogy(alpha_list,1-Pc_n,'-+b','Linewidth',2)
...
semilogy(alpha_list,1-Pc,'--pk','Linewidth',2)
hold on
semilogy(alpha_list,1-Pc_n,'-+k','Linewidth',2)
...
semilogy(alpha_list,1-Pc,'--pm','Linewidth',2)
hold on
semilogy(alpha_list,1-Pc_n,'-+m','Linewidth',2)
legend('pure squeezed state,r=0.2','squeezed state with noise,r=0.2','pure squeezed state,r=0.4','squeezed state with noise,r=0.4'...
    ,'pure squeezed state,r=0.6','squeezed state with noise,r=0.6'...
,'pure squeezed state,r=0.8','squeezed state with noise,r=0.8','pure squeezed state,r=1.0','squeezed state with noise,r=1.0')
axis([0 2.01 0.00001 1])
grid ;
%% 
